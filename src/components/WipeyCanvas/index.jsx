...
export function WipeyCanvas() {
	...
	return (
		<div className='wipeyCanvas'>
			{dimension.width == 0 && <div className='load'></div>}
			<canvas onMouseMove={manageMouseMove} ref={canvas} height={dimension.height} width={dimension.width}></canvas>
		</div>
	);
}
