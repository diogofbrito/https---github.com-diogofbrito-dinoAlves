			...
			<div className='container-default'>
				<div className='blury'>
					...
					<p>
						...
						ou vice-versa. A partir de um acto criativo, a roupa pode ser radicalmente transformada numa peça diferente. <br></br>A reciclagem de roupa ou a criação por medida já não são novidade. Já
						toda a gente reconstruiu uma peça de roupa de que não gosta, que está fora de moda, que ficou manchada ou tem algum problema de conservação.<br></br>O factor novidade do Hospital da Roupa,
						e a mais-valia deste conceito, é o de oferecer aos clientes os serviços do atelier de um criador, com a sua linguagem estética e com o ADN da sua marca, transformando peças antigas em
						peças de autor. Depois de terem passado pelo Hospital da Roupa, ganham uma nova etiqueta – SOS Dino Alves –, que é colocada junto da etiqueta original.
						<br></br>
					...
					<div className='pt-8'>
						...
						<p className='pt-8'>
							...
							<br />
							No momento do “internamento” é preenchida uma ficha que identifica a(s) peça(s) e o cliente e onde constam os seus contactos e algumas observações que possam ser úteis na criação da nova
							peça. No entanto, é importante sublinhar que o conceito deste Serviço Operação Supresa implica que o cliente não saiba previamente em que é que se transformará a velha peça de roupa. Mas
							poderá saber se assim o entender.
							<br />
